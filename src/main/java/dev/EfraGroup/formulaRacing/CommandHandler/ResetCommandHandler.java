...
public class ResetCommandHandler implements CommandExecutor {
    ...
    public ResetCommandHandler(FormulaRacing plugin, DatabaseManager mysql, TimerUtils timerUtils, APIFormulaRacing api) {
        this.plugin = plugin;
        this.mysql = mysql;
