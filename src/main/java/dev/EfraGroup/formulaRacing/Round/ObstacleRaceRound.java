...
public class ObstacleRaceRound extends Rounds {

    public ObstacleRaceRound(FormulaRacing plugin, int id, Events event, int roundIndex, RoundType roundType) {
    ...
    public void broadcastResults() {
        this.plugin.getDebugManager().logRaceSystem("Anunciando resultados da Corrida de Obstáculos...");
    }
