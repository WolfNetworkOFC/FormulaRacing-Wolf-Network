...
public class RouletteRound extends Rounds {

    public RouletteRound(FormulaRacing plugin, int id, Events event, int roundIndex, RoundType roundType) {
    ...
    public void broadcastResults() {
        this.plugin.getDebugManager().logRaceSystem("Anunciando resultados da Roleta Russa...");
    }
