...
public class TeamEliminationRound extends Rounds {

    public TeamEliminationRound(FormulaRacing plugin, int id, Events event, int roundIndex, RoundType roundType) {
    ...
    public void broadcastResults() {
        this.plugin.getDebugManager().logRaceSystem("Anunciando resultados da Eliminação por Equipe...");
    }
