...
public class DailyRaceCommand extends BaseCommand {
    ...
    private void sendHelp(CommandSender sender) {
        sender.sendMessage(ChatColor.GOLD + "=== Comandos Daily Race ===");
        sender.sendMessage(ChatColor.YELLOW + "/daily force " + ChatColor.GRAY + "- Força início");
        sender.sendMessage(ChatColor.YELLOW + "/daily stop " + ChatColor.GRAY + "- Encerra");
        sender.sendMessage(ChatColor.YELLOW + "/daily status " + ChatColor.GRAY + "- Mostra status");
        sender.sendMessage(ChatColor.YELLOW + "/daily skip " + ChatColor.GRAY + "- Pula etapa");
        sender.sendMessage(ChatColor.YELLOW + "/daily exclude add <pista>");
        sender.sendMessage(ChatColor.YELLOW + "/daily exclude remove <pista>");
        sender.sendMessage(ChatColor.YELLOW + "/daily exclude list");
        sender.sendMessage(ChatColor.YELLOW + "/daily reload");
    }
}