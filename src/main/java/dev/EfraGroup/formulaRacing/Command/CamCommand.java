...
public class CamCommand extends BaseCommand {
    ...
    public void onHelp(Player player) {
        player.sendMessage("§e=== Comandos de Câmera ===");
        player.sendMessage("§e/cam follow <jogador> §7- Segue um jogador");
        player.sendMessage("§e/cam stop §7- Para de seguir");
    }
